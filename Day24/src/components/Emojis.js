...
const Emojis = () => {
    ...
    const fetchEmojis = async () => {
        const res = await fetch(`https://emoji-api.com/emojis?search=${query}&access_key=52ab583bcd1b175d5aab0b259c0ecbc81d42abcc`);
    ...
    return (
        <div className="emojis" >
            ...
            <div className="grid-emojis">
                ...
                {loading === true ? <Loader /> : allEmojis.slice(0, 9).map(emoji =>
